...
var _utilThrowExperimental = require("./util/throw-experimental");

var _utilThrowExperimental2 = _interopRequireDefault(_utilThrowExperimental);
...
var TextLintFixer = require("./fixer/textlint-fixer");
...
var cli = {
    ...
    executeWithOptions: function executeWithOptions(cliOptions, files, text, stdinFilename) {
        ...
        if (cliOptions.fix) {
            // --fix
            (0, _utilThrowExperimental2['default'])("--fix is experimental. use `--experimental --fix`");
            ...
            return _resultsPromise.then(function (results) {
                var fixer = new TextLintFixer(results);
